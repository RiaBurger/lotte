---
title: 008-14 김리아의 코멘트a (과제-04) 
layout: home
nav_order: 14
parent: 008-02 이현서 (과제-04)
permalink: /asmt-04/008-02/comment-008-14
---
...
이 글은 "개인 성과 중심 보상은 협업 조직의 성과를 해친다"는 논제를 효과적으로 논증하고 있으며, 전체적으로 단락 간의 논리적 연결이 명확하고 모두 하나의 논지를 뒷받침하기 위한 장치로서 기능하고 있다. 다만, 본론 1에서 개인 성과 중심 보상이 신뢰를 약화시키고 경쟁을 유발한다고 주장하나, 이 점이 어떻게 조직 전체의 성과에 부정적인 영향을 미치는지 명확한 연결고리를 제시하지 않고 있다. 조직 내부에서의 경쟁이 오히려 구성원의 의욕을 자극하여 조직 전체의 성과를 향상시킬 수도 있지 않을까? 이와 같은 예상 반론에 대하여 본론 4에서 반박하고 있기는 하지만, 본론 4을 읽기 전까지는 여전히 본론 1에서 '신뢰 약화 > 성과 약화'로 이어지는 연결이 다소 부실하다고 느껴지기 때문에 한 문장 정도의 추가적 설명을 더하여 논증을 보다 명확히 한다면 좋을 것이다. 또한 본론 3의 반론이 일반적 반박을 소개하는 데 그치는 것처럼 보인다는 한계가 있으므로, 본인 논증의 논리적 결함을 지적하도록 서술 방식에 변화를 줄 필요가 있다. 이를 통해 반론과 재반박 사이의 논리적 연결을 더욱 명확히 할 수 있을 것이다.
